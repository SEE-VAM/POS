...
-- PURPOSE: High-Performance Database Views for Retail POS Operations & Reports
-- =============================================================================

-- 1. Live Available Stock by Company, Branch, and Product
...
-- 3. Executive Dashboard KPI Summaries (Real-Time Metrics)
...
select
    ...
    -- Today's Profit (Gross Profit: Line Revenue - Cost Basis)
    coalesce((
...
-- 8. Historical Profit Analysis (Line-by-Line & Aggregated)
...
-- 9. Customer Ledger Summary with Running Balance
...
-- 10. Supplier Ledger Summary with Running Balance
